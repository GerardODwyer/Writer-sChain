...
public class FantasyActivity extends AppCompatActivity implements OnChainlistener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fantasyList = (List<Chain>) getIntent().getExtras().getSerializable(Chain.FANTASY);
    ...
    protected void onResume() {
        ...
        chainAdapter = new ChainAdapter(getApplicationContext(), fantasyList, this);
    ...
    public void onChainClick(final int position) {
        Toast.makeText(getApplicationContext(), "Position is " + fantasyList.get(position).getChainID(), Toast.LENGTH_SHORT).show();
    }
}
