...
public class ActionActivity extends AppCompatActivity implements OnChainlistener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionList = (List<Chain>) getIntent().getExtras().getSerializable(Chain.ACTION);
    ...
    protected void onResume() {
        ...
        chainAdapter = new ChainAdapter(getApplicationContext(), actionList, this);
    ...
    public void onChainClick(final int position) {
        Toast.makeText(getApplicationContext(), "Position is " + actionList.get(position).getChainID(), Toast.LENGTH_SHORT).show();
    }
}
