...
public class DramaActivity extends AppCompatActivity implements OnChainlistener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dramaList = (List<Chain>) getIntent().getExtras().getSerializable(Chain.DRAMA);
    ...
    protected void onResume() {
        ...
        chainAdapter = new ChainAdapter(getApplicationContext(), dramaList, this);
    ...
    public void onChainClick(final int position) {
        Toast.makeText(getApplicationContext(), "Position is " + dramaList.get(position).getChainID(), Toast.LENGTH_SHORT).show();
    }
}
