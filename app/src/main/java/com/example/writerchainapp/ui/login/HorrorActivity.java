...
import com.example.writerchainapp.Adapters.HorrorAdapter;
...
public class HorrorActivity extends AppCompatActivity implements ChainAdapter.ItemClickListener {
    ...
    private HorrorAdapter chainAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                chainAdapter = new HorrorAdapter(getApplicationContext(), chainsList);
