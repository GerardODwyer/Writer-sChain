...
public class WesternActivity extends AppCompatActivity implements OnChainlistener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        westrenList = (List<Chain>) getIntent().getExtras().getSerializable(Chain.WESTREN);
    ...
    protected void onResume() {
        ...
        chainAdapter = new ChainAdapter(getApplicationContext(), westrenList, this);
    ...
    public void onChainClick(final int position) {
        Toast.makeText(getApplicationContext(), "Position is " + westrenList.get(position).getChainID(), Toast.LENGTH_SHORT).show();
    }
}
