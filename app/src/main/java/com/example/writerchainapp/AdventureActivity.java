...
public class AdventureActivity extends AppCompatActivity implements OnChainlistener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adventureList = (List<Chain>) getIntent().getExtras().getSerializable(Chain.ADVENTURE);
    ...
    protected void onResume() {
        ...
        chainAdapter = new ChainAdapter(getApplicationContext(), adventureList, this);
    ...
    public void onChainClick(final int position) {
        Toast.makeText(getApplicationContext(), "Position is " + adventureList.get(position).getChainID(), Toast.LENGTH_SHORT).show();
    }
}
